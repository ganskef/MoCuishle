package de.ganskef.mocuishle2.modify;

import static org.junit.Assert.assertEquals;

import de.ganskef.mocuishle.modify.IModifier;
import de.ganskef.mocuishle.modify.ReplaceAnchors;
...
public class ReplaceAnchorsTest {
  ...
  private HtmlModifierTest.ModifyCacheableAdapter cached;
  ...
  @Before
  public void before() {
    cached = new HtmlModifierTest.ModifyCacheableAdapter();
  ...
  public void testSimpleHrefTwiceWillBeModified() {
    String expected =
        "<a href=\"xxx\"><font color=\"#B00000\">xxx</font></a><a href=\"xxx\"><font color=\"#B00000\">xxx</font></a>";
  ...
  public void testSimpleHrefEmptyWillBeModified() {
    ...
    String expected =
        "<a href=\"xxx\"><font color=\"#B00000\"></font></a><a href=\"xxx\"><font color=\"#B00000\">xxx</font></a>";
  ...
  public void testAnchorWithClassAfterHrefWillBeModified() {
    String expected =
        "<a href=\"xxx\" class=\"yyy\" target=\"_top\"><font color=\"#B00000\">xxx</font></a>";
  ...
  public void testAnchorWithAcronymTagInTextWillBeModified() {
    ...
    //
    String expected =
        "<a href=\"xxx\"><font color=\"#B00000\">x<acronym class=\"acronym\">x</acronym>x</font></a>";
  ...
  public void testAnchorWithQuotedEntitiesReferencesUnquoted() {
    ...
    //
    String expected =
        "<a href=\"xxx?a=a&amp;b=&quot;&lt;b&gt;&quot;\"><font color=\"#B00000\">xxx</font></a>";
