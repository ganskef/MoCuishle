...
public class HtmlModifierTest {
  ...
  public void testModify() throws Exception {
    String expected =
        "<html><head><!--MoCuishle begin head--><title>"
    ...
    assertEquals(
        expected,
        modify("<html><head><title></title></head><body><a href=\"xxx\">xxx</a></body></html>"));
  }

  @Test
  public void testModifyEncodedUrlInBodyEnd() throws Exception {
    cached =
        new ModifyCacheableAdapter() {
          @Override
          public Markup getMarkup() {
            return new Markup(getPlatform()) {
              @Override
    ...
    assertEquals(
        expected,
        modify(
            "<html><head><title></title></head><body><a href=\"http://yyy\">xxx</a></body></html>"));
  }
}
