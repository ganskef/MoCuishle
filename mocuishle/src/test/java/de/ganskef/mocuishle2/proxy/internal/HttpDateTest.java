 ...
 */
package de.ganskef.mocuishle2.proxy.internal;
...
public class HttpDateTest {
  ...
  @Test
  void parseStandardFormats() throws Exception {
    ...
    assertThat(HttpDate.parse("Friday, 06-Jun-14 12:30:30 GMT").getTime())
        .isEqualTo(1402057830000L);
  ...
  void format() throws Exception {
    ...
    assertThat(HttpDate.format(new Date(1402057830000L)))
        .isEqualTo("Fri, 06 Jun 2014 12:30:30 GMT");
  }

  @Test
  void parseNonStandardStrings() throws Exception {
    ...
    assertThat(HttpDate.parse("Thursday, 01-Jan-1970 00:00:00 GMT-01:00").getTime())
        .isEqualTo(3600000L);
    assertThat(HttpDate.parse("Thursday, 01-Jan-1970 00:00:00 PST").getTime()).isEqualTo(28800000L);
    // Ignore trailing junk
    assertThat(HttpDate.parse("Thursday, 01-Jan-1970 00:00:00 PST JUNK").getTime())
        .isEqualTo(28800000L);
