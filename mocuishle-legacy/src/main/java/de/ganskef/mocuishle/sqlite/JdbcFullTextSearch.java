...
public class JdbcFullTextSearch implements IFullTextSearch {
	...
	private static final Logger log = LoggerFactory.getLogger(JdbcFullTextSearch.class);
	...
	public JdbcFullTextSearch(ICache cache) {
		mCache = cache;
	}

	@Override
	public IFullTextSearch.SearchResult query(String queryString, int index, int count) {
		try {
			openDatabase();
